-- =============================================================================
-- Consolidated migration (module bundle): 0009_multi_tenant_platform_admin.sql
-- Sources merged in order (do not reorder):
--   51_multi_tenant_foundation.sql
--   52_leads_status_values.sql
--   53_user_list_view_add_company_id.sql
--   54_bootstrap_company_accounting_defaults.sql
--   55_add_leads_business_category.sql
--   56_add_companies_business_category.sql
--   57_companies_owner_name_and_soft_delete.sql
--   58_enforce_active_company_rls.sql
--   59_users_super_admin_select.sql
--   60_users_before_insert_default_company_id.sql
--   61_is_my_company_active_respects_soft_delete.sql
--   62_business_logos_storage_super_admin.sql
--   63_super_admin_activity_log.sql
-- =============================================================================


-- >>> begin: 51_multi_tenant_foundation.sql
/* =============================================================================
...
-- <<< end: 51_multi_tenant_foundation.sql

-- >>> begin: 52_leads_status_values.sql
/* =============================================================================
...
-- <<< end: 52_leads_status_values.sql

-- >>> begin: 53_user_list_view_add_company_id.sql
...
-- <<< end: 53_user_list_view_add_company_id.sql

-- >>> begin: 54_bootstrap_company_accounting_defaults.sql
/* =============================================================================
...
-- <<< end: 54_bootstrap_company_accounting_defaults.sql

-- >>> begin: 55_add_leads_business_category.sql
/* =============================================================================
...
-- <<< end: 55_add_leads_business_category.sql

-- >>> begin: 56_add_companies_business_category.sql
/* =============================================================================
...
-- <<< end: 56_add_companies_business_category.sql

-- >>> begin: 57_companies_owner_name_and_soft_delete.sql
/* =============================================================================
...
-- <<< end: 57_companies_owner_name_and_soft_delete.sql

-- >>> begin: 58_enforce_active_company_rls.sql
/* =============================================================================
...
-- <<< end: 58_enforce_active_company_rls.sql

-- >>> begin: 59_users_super_admin_select.sql
...
-- <<< end: 59_users_super_admin_select.sql

-- >>> begin: 60_users_before_insert_default_company_id.sql
...
-- <<< end: 60_users_before_insert_default_company_id.sql

-- >>> begin: 61_is_my_company_active_respects_soft_delete.sql
...
-- <<< end: 61_is_my_company_active_respects_soft_delete.sql

-- >>> begin: 62_business_logos_storage_super_admin.sql
/* =============================================================================
...
-- <<< end: 62_business_logos_storage_super_admin.sql

-- >>> begin: 63_super_admin_activity_log.sql
/* =============================================================================
...
-- <<< end: 63_super_admin_activity_log.sql
