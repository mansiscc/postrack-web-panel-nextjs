-- =============================================================================
-- Consolidated migration (module bundle): 0007_app_updates.sql
-- Sources merged in order (do not reorder):
--   39_create_app_updates_table_and_policies.sql
-- =============================================================================


-- >>> begin: 39_create_app_updates_table_and_policies.sql
/* =============================================================================
...
-- <<< end: 39_create_app_updates_table_and_policies.sql
