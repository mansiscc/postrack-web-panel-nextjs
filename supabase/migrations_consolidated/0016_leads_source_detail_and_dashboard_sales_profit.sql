-- =============================================================================
-- Consolidated migration (module bundle): 0016_leads_source_detail_and_dashboard_sales_profit.sql
-- Sources merged in order (do not reorder):
--   74_leads_source_detail_and_dashboard_sales_profit.sql
--     (formerly migrations/74_add_leads_source_detail.sql +
--      migrations/75_add_dashboard_sales_profit.sql)
-- =============================================================================


-- >>> begin: 74_leads_source_detail_and_dashboard_sales_profit.sql — Part A (schema)
/* =============================================================================
   Leads source_detail + app_updates.is_blocked cleanup
   ============================================================================= */
...
-- >>> begin: 74_leads_source_detail_and_dashboard_sales_profit.sql — Part B (dashboard RPC)
/* =============================================================================
   Admin dashboard sales profit on get_admin_dashboard_totals()
   - today_sales_revenue: net item revenue (sold − returned)
   - today_cogs: purchase price × qty sold, net of returns
   - today_sales_profit: revenue − COGS
